...
@pytest.fixture
async def mock_brainstorm_chain(mocker):
...
@pytest.fixture
async def mock_bible_chain(mocker, bible: Bible):
...
@pytest.fixture
def bible_engine(mock_brainstorm_chain, mock_bible_chain):
    return BibleEngine()
...
async def test_bible_engine_generate(
    bible_engine: BibleEngine,
    bible_generate_context: BibleEngine.BibleGenerateContext,
    mock_bible_chain,
):
