...
# ⚡ Bolt: Cache LLM initialization to prevent redundant creation of expensive client instances.
# This ensures a singleton pattern is used across the application.
@functools.cache
