...
def get_llm() -> ChatOpenAI:
    # ⚡ Cache the LLM client instance to avoid repeated initialization overhead
    # and to reduce memory footprint across the application. ChatOpenAI is thread-safe.
    return ChatOpenAI(
