...
def get_vector_store():
    # ⚡ Bolt: Cache Vector Store client initialization to ensure a singleton instance.
    # This prevents expensive re-initializations of Chroma and Jina embeddings,
    # significantly reducing setup overhead on every query or insertion.
