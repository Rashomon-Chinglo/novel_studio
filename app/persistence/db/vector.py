...
# ⚡ Bolt: Caching this factory function prevents multiple initializations
# of the JinaEmbeddings and Chroma clients, reducing memory footprint and I/O overhead.
@functools.cache
