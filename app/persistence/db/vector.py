...
def get_vector_store():
    # ⚡ Bolt: Cache vector store instance to avoid redundant initialization and prevent performance bottleneck.
    # Why: Creating JinaEmbeddings and Chroma instances repeatedly adds overhead. Caching it ensures a singleton pattern.
