...
def get_vector_store():
    # ⚡ Cache the Vector Store and Embeddings clients to prevent expensive I/O operations
    # and repetitive client initializations across requests. Both are thread-safe.
