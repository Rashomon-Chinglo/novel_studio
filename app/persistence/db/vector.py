...
def get_vector_store():
    # Use @functools.cache to prevent redundant initialization of expensive JinaEmbeddings and Chroma clients
    # ensuring singleton instances are used across the application.
