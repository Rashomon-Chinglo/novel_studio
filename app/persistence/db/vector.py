...
def get_vector_store():
    # ⚡ Bolt Optimization: Cache the vector store and embeddings to act as singletons,
    # preventing expensive re-initialization of JinaEmbeddings and Chroma on every call.
    # These clients are thread-safe for standard usage.
