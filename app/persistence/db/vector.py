...
# ⚡ Bolt Optimization: Cache the Chroma vector store and JinaEmbeddings client
# to avoid expensive re-initialization and duplicate connections across requests.
@functools.cache
