...
# Cache the vector store instance to avoid re-initializing the heavy JinaEmbeddings and Chroma client
# on every call. This reduces overhead from ~47ms to ~2µs per call.
@functools.lru_cache
