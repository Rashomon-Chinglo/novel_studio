...
# ⚡ Bolt: Cache vector store and embedding model to avoid redundant instantiations.
# Expected Impact: Prevents re-loading JinaEmbeddings and Chroma client on every call, saving significant memory and latency.
