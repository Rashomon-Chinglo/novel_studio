...
def get_vector_store():
    # ⚡ Bolt: Cache Chroma vector store initialization to prevent redundant JinaEmbeddings/Chroma client instantiations, reducing memory usage and startup latency.
