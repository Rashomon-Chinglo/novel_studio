...
class MaterialService:
    ...
    async def save_snippets(self, title: str, snippets: list[MaterialSnippet]) -> None:
        ...
        try:
            ...
            # ⚡ Bolt: Using asynchronous `aadd_texts` instead of synchronous `add_texts` to prevent blocking the async event loop during I/O operations, improving concurrency.
