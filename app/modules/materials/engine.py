...
class MaterialEngine:
    ...
    async def process_content(self, title: str, full_text: str):
        ...
        # ⚡ Bolt: Increased concurrency to improve LLM processing throughput
        ...
        all_snippets = [snippet for batch in results for snippet in batch]
